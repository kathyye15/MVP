    ...
    <ul className="application-list">
      <li className="col-header-container" style={{display: 'flex'}}>
        <div style={{display: 'flex', gap: '0.5rem'}}>
          ...
          <button className="hidden col-header" ><i className="fa-solid fa-pen-to-square" /></button>
          <button className="hidden col-header"><i className="fa-regular fa-trash-can"/></button>
        </div>
      </li>
